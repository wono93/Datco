...
<div id="helpUserPw-container">
	<form action="<%=request.getContextPath()%>/user/helpUserPwCha"
		...
		>
		<h4 class="helpUserPwtitle">비밀번호 변경하기</h4>
		<div class="findbox">
			...
			<input type="password" id="passwordchk" name="passwordchk" maxlength="16">
			<span id="pwdchkMsg"></span>
			<div id="btn">
					<center><input type="submit" id="submit" value="패스워드 변경하기" onclick="return password_validate();"></center>
				</div>
		</div>
</div>
</form>
...
function password_validate(){
	...
	if(pwd_new==null||pwd_chk==null) return false
